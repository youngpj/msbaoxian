 ...
 * @Last Modified time: 2018-12-17 16:40:07
...
<div class="provision">
    ...
    <div class="pagewarp">
        <div class="pagebg">
            <div class="firstpage" style="height:15.5rem">
                ...
                <h3 class="provision_title" style="padding-bottom:0.48rem">民生康e保费用补偿型医疗保险（A款）条款</h3> 
   ...
   <div class="bottomfixed">
    ...
    <!-- <a href="javascript:;" v-if="!isIos"  @click="exportfile"  > -->
...
<script>
import provision_json from '../../assets/provision.js' 
